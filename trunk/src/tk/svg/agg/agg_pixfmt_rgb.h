...
namespace agg
{
    ...
    public:
        ...
        {
            value_type* p = static_cast<value_type*>(m_rbuf->row_ptr(y)) + x + x + x;
        ...
        {
            value_type* p = static_cast<value_type*>(m_rbuf->row_ptr(x, y, 1)) + x + x + x;
            p[order_type::R] = c.r;
            p[order_type::G] = c.g;
            p[order_type::B] = c.b;
        }
        ...
        {
            copy_or_blend_pix(static_cast<value_type*>(m_rbuf->row_ptr(x, y, 1)) + x + x + x, c, cover);
        }
        ...
        AGG_INLINE void copy_hline(int x, int y, 
                                   ...
                                   const color_type& c)
        {
            value_type* p = static_cast<value_type*>(m_rbuf->row_ptr(x, y, len)) + x + x + x;
            do
            {
                p[order_type::R] = c.r; 
                p[order_type::G] = c.g; 
                        ...
                        int8u cover)
        {
            ...
            if(psrc)
            {
                psrc += xsrc * 4;
                value_type* pdst = 
                    static_cast<value_type*>(m_rbuf->row_ptr(xdst, ydst, len)) + xdst * 3;   
