    ...
    public:
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                const value_type* fg_ptr = static_cast<const value_type*>
    ...
    public:
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                fg_ptr = static_cast<const value_type*>(base_type::source().span(x_lr, y_lr, 2));
                ...
                fg_ptr = static_cast<const value_type*>(base_type::source().next_x());
                weight = x_hr * (image_subpixel_scale - y_hr);
                fg[0] += weight * *fg_ptr++;
                fg[1] += weight * *fg_ptr++;
                fg[2] += weight * *fg_ptr;

                fg_ptr = static_cast<const value_type*>(base_type::source().next_y());
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                   ...
                   x_lr <  maxx && y_lr <  maxy) 
                {
                    ...
                    fg_ptr = static_cast<const value_type*>
    ...
    public:
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                fg_ptr = static_cast<const value_type*>(base_type::source().span(x_lr + start, 
                                                                     y_lr + start, 
                                                                     diameter));
                for(;;)
                {
    ...
    public:
        ...
        void generate(color_type* span, int x, int y, unsigned len)
        {
            ...
            do
            {
                ...
                int x_hr2 = x_hr;
                const value_type* fg_ptr = 
                    static_cast<const value_type*>(base_type::source().span(x_lr, y_lr, len_x_lr));
                for(;;)
                {
