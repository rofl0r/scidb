...
static const HashEntry aHtmlCssConstant[] = {
    ...
    {"line-through", -101},
    {"list-item", -101},
    {"lower-alpha", CSS_CONST__TKHTML_JUSTIFY - 100},
    ...
    const char *z;
{
    int aTable[] = {
        ...
        CSS_CONST_EMBED - 100, CSS_CONST_FUCHSIA - 100, -101, -101, -101, 
        CSS_CONST_SCROLL - 100, CSS_CONST_PRE - 100, -101, 
        CSS_CONST_TABLE_COLUMN_GROUP - 100, CSS_CONST_LOWER_ALPHA - 100, 
        CSS_CONST_INLINE_TABLE - 100, CSS_CONST_SEPARATE - 100, 
        CSS_CONST_CENTER - 100, -101, CSS_CONST_TABLE_HEADER_GROUP - 100, 
