...
public:
  ...
  Position(const std::string& f, bool c960, bool threec, Thread* t) { set(f, c960, threec, t); }
#else
  ...
  // Text input/output
#ifdef THREECHECK
  void set(const std::string& fen, bool isChess960, bool isThreeCheck, Thread* th);
#else
