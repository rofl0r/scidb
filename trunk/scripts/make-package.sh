...
requires=""
if [ "$type" = "debian" ]; then
	requires="tk8.5,tcl8.5,libX11-6,libsm6,libice6,libxcursor1,libexpat1,libstdc++6,libc6,libgcc1,libxft2,libfontconfig1,libfreetype6,zlib1g,desktop-file-utils,xdg-util"
fi
