...
case $type in
	debian)
		requires="desktop-file-utils,gdbm,hicolor-icon-theme,libc6,libexpat1,libfontconfig1,libfreetype6,libgcc1,libice6,libsm6,libstdc++6,libX11-6,libxcursor1,libxft2,shared-mime-info,tcl8.5,tk8.5,xdg-utils,zlib1g";;
	rpm)
